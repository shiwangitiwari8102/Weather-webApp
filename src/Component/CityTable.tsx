...
//   const apiKey = "e8c24597158bcaa170b724112df7498f"; // Replace with your OpenWeatherMap API key
//   const [cities, setCities] = useState<City[]>([]);
//   const [selectedCity, setSelectedCity] = useState<string | null>(null); // State to store selected city name
//   const [weatherData, setWeatherData] = useState<any | null>(null); // State to store weather data for the selected city
...
//       // Fetch more cities when the observer node becomes visible
//       fetchMoreCities();
//     }
//   };
